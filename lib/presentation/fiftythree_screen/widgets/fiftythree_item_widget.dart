...
import '../models/fiftythree_item_model.dart';
import 'package:flutter/material.dart';
import 'package:testapp/core/app_export.dart';

// ignore: must_be_immutable
class FiftythreeItemWidget extends StatelessWidget {
  FiftythreeItemWidget(this.fiftythreeItemModelObj);

  FiftythreeItemModel fiftythreeItemModelObj;

  var controller = Get.find<FiftythreeController>();
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: CommonImageView(
                          svgPath: ImageConstant.imgCurrencyrupee,
                          height: getSize(
                            20.00,
                          ),
                          width: getSize(
