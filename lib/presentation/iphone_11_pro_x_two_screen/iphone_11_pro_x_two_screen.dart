import '../iphone_11_pro_x_two_screen/widgets/listvideocamera7_item_widget.dart';
import '../iphone_11_pro_x_two_screen/widgets/slidereducational_activity7_item_widget.dart';
import 'controller/iphone_11_pro_x_two_controller.dart';
import 'models/listvideocamera7_item_model.dart';
import 'models/slidereducational_activity7_item_model.dart';
...
class Iphone11ProXTwoScreen extends GetWidget<Iphone11ProXTwoController> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          styleType: Style.bgFillWhiteA700_8,
        ),
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProXTwoModelObj.value
                          .listvideocamera7ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera7ItemModel model = controller
                            .iphone11ProXTwoModelObj
                            .value
                            .listvideocamera7ItemList[index];
                        return Listvideocamera7ItemWidget(
                          model,
                        );
                      },
                    ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage6721,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProXTwoModelObj.value
                              .slidereducationalActivity7ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity7ItemModel model =
                                controller.iphone11ProXTwoModelObj.value
                                    .slidereducationalActivity7ItemList[index];
                            return SlidereducationalActivity7ItemWidget(
                              model,
                            );
                          },
                        ),
                        ...
                        child: Obx(
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller.iphone11ProXTwoModelObj.value
                                  .slidereducationalActivity7ItemList.length,
