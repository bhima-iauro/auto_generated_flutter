...
class Listhrishabhsatpute6ItemWidget extends StatelessWidget {
  Listhrishabhsatpute6ItemWidget(this.listhrishabhsatpute6ItemModelObj);

  Listhrishabhsatpute6ItemModel listhrishabhsatpute6ItemModelObj;

  var controller = Get.find<Frame30584Controller>();
