...
import '../models/seva_three_item_model.dart';
import 'package:flutter/material.dart';
import 'package:testapp/core/app_export.dart';

// ignore: must_be_immutable
class SevaThreeItemWidget extends StatelessWidget {
  SevaThreeItemWidget(this.sevaThreeItemModelObj);

  SevaThreeItemModel sevaThreeItemModelObj;

  var controller = Get.find<SevaThreeController>();
