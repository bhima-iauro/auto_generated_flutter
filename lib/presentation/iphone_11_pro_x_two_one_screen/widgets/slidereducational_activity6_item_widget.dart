...
class SlidereducationalActivity6ItemWidget extends StatelessWidget {
  SlidereducationalActivity6ItemWidget(
      this.slidereducationalActivity6ItemModelObj);

  SlidereducationalActivity6ItemModel slidereducationalActivity6ItemModelObj;

  var controller = Get.find<Iphone11ProXTwoOneController>();
