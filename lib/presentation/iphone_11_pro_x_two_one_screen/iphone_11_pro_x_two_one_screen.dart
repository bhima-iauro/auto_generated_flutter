import '../iphone_11_pro_x_two_one_screen/widgets/listvideocamera6_item_widget.dart';
import '../iphone_11_pro_x_two_one_screen/widgets/slidereducational_activity6_item_widget.dart';
import 'controller/iphone_11_pro_x_two_one_controller.dart';
import 'models/listvideocamera6_item_model.dart';
import 'models/slidereducational_activity6_item_model.dart';
...
class Iphone11ProXTwoOneScreen extends GetWidget<Iphone11ProXTwoOneController> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          styleType: Style.bgFillWhiteA700_7,
        ),
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProXTwoOneModelObj.value
                          .listvideocamera6ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera6ItemModel model = controller
                            .iphone11ProXTwoOneModelObj
                            .value
                            .listvideocamera6ItemList[index];
                        return Listvideocamera6ItemWidget(
                          model,
                        );
                      },
                    ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage6720,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProXTwoOneModelObj.value
                              .slidereducationalActivity6ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity6ItemModel model =
                                controller.iphone11ProXTwoOneModelObj.value
                                    .slidereducationalActivity6ItemList[index];
                            return SlidereducationalActivity6ItemWidget(
                              model,
                            );
                          },
                        ),
                        ...
                        child: Obx(
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller.iphone11ProXTwoOneModelObj.value
                                  .slidereducationalActivity6ItemList.length,
