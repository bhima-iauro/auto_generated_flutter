...
class CancelledSevaItemWidget extends StatelessWidget {
  CancelledSevaItemWidget(this.cancelledSevaItemModelObj);

  CancelledSevaItemModel cancelledSevaItemModelObj;

  var controller = Get.find<CancelledSevaController>();
