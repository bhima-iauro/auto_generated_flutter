...
import '../models/listrectangle3216_item_model.dart';
import 'package:flutter/material.dart';
import 'package:testapp/core/app_export.dart';
import 'package:testapp/widgets/custom_button.dart';

// ignore: must_be_immutable
class Listrectangle3216ItemWidget extends StatelessWidget {
  Listrectangle3216ItemWidget(this.listrectangle3216ItemModelObj);

  Listrectangle3216ItemModel listrectangle3216ItemModelObj;

  var controller = Get.find<Iphone11ProX478Controller>();
                ...
                Align(
                  ...
                  child: ClipRRect(
                    ...
                    child: CommonImageView(
                      imagePath: ImageConstant.imgRectangle32108,
                      height: getVerticalSize(
                        98.00,
                      ),
                      width: getHorizontalSize(
