import '../iphone_11_pro_x_nine_one_screen/widgets/listvideocamera2_item_widget.dart';
import '../iphone_11_pro_x_nine_one_screen/widgets/slidereducational_activity2_item_widget.dart';
import 'controller/iphone_11_pro_x_nine_one_controller.dart';
import 'models/listvideocamera2_item_model.dart';
import 'models/slidereducational_activity2_item_model.dart';
...
class Iphone11ProXNineOneScreen
    extends GetWidget<Iphone11ProXNineOneController> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          styleType: Style.bgFillWhiteA700_3,
        ),
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProXNineOneModelObj.value
                          .listvideocamera2ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera2ItemModel model = controller
                            .iphone11ProXNineOneModelObj
                            .value
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage673,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProXNineOneModelObj
                              .value.slidereducationalActivity2ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity2ItemModel model =
                                controller.iphone11ProXNineOneModelObj.value
                                    .slidereducationalActivity2ItemList[index];
                            return SlidereducationalActivity2ItemWidget(
                              model,
                            );
                          },
                        ),
                          ...
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller
                                  .iphone11ProXNineOneModelObj
                                  .value
                                  .slidereducationalActivity2ItemList
                                  .length,
