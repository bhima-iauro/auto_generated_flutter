...
class SlidereducationalActivity2ItemWidget extends StatelessWidget {
  SlidereducationalActivity2ItemWidget(
      this.slidereducationalActivity2ItemModelObj);

  SlidereducationalActivity2ItemModel slidereducationalActivity2ItemModelObj;

  var controller = Get.find<Iphone11ProXNineOneController>();
