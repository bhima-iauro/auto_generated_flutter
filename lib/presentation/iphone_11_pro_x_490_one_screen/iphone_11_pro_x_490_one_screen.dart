import '../iphone_11_pro_x_490_one_screen/widgets/listvideocamera3_item_widget.dart';
import '../iphone_11_pro_x_490_one_screen/widgets/slidereducational_activity3_item_widget.dart';
import 'controller/iphone_11_pro_x_490_one_controller.dart';
import 'models/listvideocamera3_item_model.dart';
import 'models/slidereducational_activity3_item_model.dart';
...
class Iphone11ProX490OneScreen extends GetWidget<Iphone11ProX490OneController> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          styleType: Style.bgFillWhiteA700_4,
        ),
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProX490OneModelObj.value
                          .listvideocamera3ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera3ItemModel model = controller
                            .iphone11ProX490OneModelObj
                            .value
                            .listvideocamera3ItemList[index];
                        return Listvideocamera3ItemWidget(
                          model,
                        );
                      },
                    ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage6710,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProX490OneModelObj.value
                              .slidereducationalActivity3ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity3ItemModel model =
                                controller.iphone11ProX490OneModelObj.value
                                    .slidereducationalActivity3ItemList[index];
                            return SlidereducationalActivity3ItemWidget(
                              model,
                            );
                          },
                        ),
                        ...
                        child: Obx(
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller.iphone11ProX490OneModelObj.value
                                  .slidereducationalActivity3ItemList.length,
