...
class SlidereducationalActivity3ItemWidget extends StatelessWidget {
  SlidereducationalActivity3ItemWidget(
      this.slidereducationalActivity3ItemModelObj);

  SlidereducationalActivity3ItemModel slidereducationalActivity3ItemModelObj;

  var controller = Get.find<Iphone11ProX490OneController>();
