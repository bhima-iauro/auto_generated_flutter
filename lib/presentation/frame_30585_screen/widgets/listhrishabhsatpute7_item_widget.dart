...
class Listhrishabhsatpute7ItemWidget extends StatelessWidget {
  Listhrishabhsatpute7ItemWidget(this.listhrishabhsatpute7ItemModelObj);

  Listhrishabhsatpute7ItemModel listhrishabhsatpute7ItemModelObj;

  var controller = Get.find<Frame30585Controller>();
