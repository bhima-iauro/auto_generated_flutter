...
class SlidereducationalActivity4ItemWidget extends StatelessWidget {
  SlidereducationalActivity4ItemWidget(
      this.slidereducationalActivity4ItemModelObj);

  SlidereducationalActivity4ItemModel slidereducationalActivity4ItemModelObj;

  var controller = Get.find<Iphone11ProXNineThreeController>();
