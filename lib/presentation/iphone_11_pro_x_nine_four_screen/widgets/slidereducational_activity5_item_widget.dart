...
class SlidereducationalActivity5ItemWidget extends StatelessWidget {
  SlidereducationalActivity5ItemWidget(
      this.slidereducationalActivity5ItemModelObj);

  SlidereducationalActivity5ItemModel slidereducationalActivity5ItemModelObj;

  var controller = Get.find<Iphone11ProXNineFourController>();
