import '../iphone_11_pro_x_nine_four_screen/widgets/listvideocamera5_item_widget.dart';
import '../iphone_11_pro_x_nine_four_screen/widgets/slidereducational_activity5_item_widget.dart';
import 'controller/iphone_11_pro_x_nine_four_controller.dart';
import 'models/listvideocamera5_item_model.dart';
import 'models/slidereducational_activity5_item_model.dart';
...
class Iphone11ProXNineFourScreen
    extends GetWidget<Iphone11ProXNineFourController> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          styleType: Style.bgFillWhiteA700_6,
        ),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: CommonImageView(
                              svgPath: ImageConstant.imgVector6Red50,
                              height: getVerticalSize(
                                208.00,
                              ),
                              width: getHorizontalSize(
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProXNineFourModelObj.value
                          .listvideocamera5ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera5ItemModel model = controller
                            .iphone11ProXNineFourModelObj
                            .value
                            .listvideocamera5ItemList[index];
                        return Listvideocamera5ItemWidget(
                          model,
                        );
                      },
                    ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage6717,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProXNineFourModelObj
                              .value.slidereducationalActivity5ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity5ItemModel model =
                                controller.iphone11ProXNineFourModelObj.value
                                    .slidereducationalActivity5ItemList[index];
                            return SlidereducationalActivity5ItemWidget(
                              model,
                            );
                          },
                        ),
                          ...
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller
                                  .iphone11ProXNineFourModelObj
                                  .value
                                  .slidereducationalActivity5ItemList
                                  .length,
