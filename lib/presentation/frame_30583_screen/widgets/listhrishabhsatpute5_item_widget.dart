...
class Listhrishabhsatpute5ItemWidget extends StatelessWidget {
  Listhrishabhsatpute5ItemWidget(this.listhrishabhsatpute5ItemModelObj);

  Listhrishabhsatpute5ItemModel listhrishabhsatpute5ItemModelObj;

  var controller = Get.find<Frame30583Controller>();
