import '../iphone_11_pro_x_nine_two_screen/widgets/listvideocamera1_item_widget.dart';
import '../iphone_11_pro_x_nine_two_screen/widgets/slidereducational_activity1_item_widget.dart';
import 'controller/iphone_11_pro_x_nine_two_controller.dart';
import 'models/listvideocamera1_item_model.dart';
import 'models/slidereducational_activity1_item_model.dart';
...
class Iphone11ProXNineTwoScreen
    extends GetWidget<Iphone11ProXNineTwoController> {
  @override
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.iphone11ProXNineTwoModelObj.value
                          .listvideocamera1ItemList.length,
                      itemBuilder: (context, index) {
                        Listvideocamera1ItemModel model = controller
                            .iphone11ProXNineTwoModelObj
                            .value
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CommonImageView(
                                    imagePath: ImageConstant.imgImage671,
                                    height: getSize(
                                      98.00,
                                    ),
                                    width: getSize(
                    ...
                    children: [
                      Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.iphone11ProXNineTwoModelObj
                              .value.slidereducationalActivity1ItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidereducationalActivity1ItemModel model =
                                controller.iphone11ProXNineTwoModelObj.value
                                    .slidereducationalActivity1ItemList[index];
                            return SlidereducationalActivity1ItemWidget(
                              model,
                            );
                          },
                        ),
                          ...
                          () => Container(
                            ...
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller
                                  .iphone11ProXNineTwoModelObj
                                  .value
                                  .slidereducationalActivity1ItemList
                                  .length,
