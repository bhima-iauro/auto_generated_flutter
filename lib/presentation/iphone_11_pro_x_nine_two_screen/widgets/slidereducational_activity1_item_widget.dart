...
class SlidereducationalActivity1ItemWidget extends StatelessWidget {
  SlidereducationalActivity1ItemWidget(
      this.slidereducationalActivity1ItemModelObj);

  SlidereducationalActivity1ItemModel slidereducationalActivity1ItemModelObj;

  var controller = Get.find<Iphone11ProXNineTwoController>();
