...
import '../models/eighty_item_model.dart';
...
class EightyItemWidget extends StatelessWidget {
  EightyItemWidget(this.eightyItemModelObj);

  EightyItemModel eightyItemModelObj;

  var controller = Get.find<EightyController>();
        ...
        child: Stack(
          ...
          children: [
            ...
            CustomDropDown(
              ...
              alignment: Alignment.bottomLeft,
              items: eightyItemModelObj.dropdownItemList,
              onChanged: (value) {
